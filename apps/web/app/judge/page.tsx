  ...
  return (
    <main className="wrap judge">
      ...
      <p className="judge-lede">
        One input → one green card. The score is deterministic arithmetic over Nansen fields only — no market cap, no volume, no search rank — and every verdict
        ships with the full list of Nansen calls that produced it.
      </p>
