...
[![Submission on X](https://img.shields.io/badge/𝕏_Submission-@edycutjong-000000?style=for-the-badge&labelColor=0a0e13)](https://x.com/edycutjong/status/2103598350952239233)
...
![tests](https://img.shields.io/badge/tests-149%20passing-22c55e?style=flat)
...
[![Release](https://img.shields.io/github/v/release/edycutjong/whichone?sort=semver&style=flat)](https://github.com/edycutjong/whichone/releases/latest)
...
| Metric | Value | Source |
|---|---|---|
| Tests | **149 tests** (`npm test`) — regression tests named for the defect they pin | `packages/core/test/` |
...
| Unit Testing | vitest, 149 tests, v8 coverage | ✅ |
